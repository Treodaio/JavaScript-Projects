...
const RESULT_SCREEN_BACK_BUTTON_ID = 'js-back-to-basics';
const RESULT_SCREEN_END_SCREEN_ID = 'js-end-screen';
const RESULT_SCREEN_GAME_WIN_CLASS = 'js-end-screen--is-win';
...
class ResultScreen extends Common {
    ...
    viewResultScreen(isGameWin, playerPoints, level) {
        if (isGameWin) { this.element.classList.add(RESULT_SCREEN_GAME_WIN_CLASS) }
        else { this.element.classList.remove(RESULT_SCREEN_GAME_WIN_CLASS) }
